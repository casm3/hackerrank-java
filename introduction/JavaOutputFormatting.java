...
public class JavaOutputFormatting {
  public static void main(String[] args) {
    ...
    for(int i=0;i<3;i++){
      ...
      String paddedNumber = "";
      if (x < 10) {
        paddedNumber = "00" + Integer.toString(x);
      }
      else if (x < 100) {
        paddedNumber = "0" + Integer.toString(x);
      }
      else {
        paddedNumber = Integer.toString(x);
      }
      System.out.println(s1 + space.repeat(15-s1.length()) + paddedNumber);
    }
    System.out.println("================================");
  }
}
